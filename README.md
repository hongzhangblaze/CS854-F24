...
**After Lectures**: Participation also involves contributing to discussions on [Piazza](https://piazza.com/uwaterloo.ca/fall2024/cs854
![image](https://github.com/user-attachments/assets/c9b4d7aa-66c6-4469-aa4d-f0dd2dd3ae3e)
). The group responsible for the summary should initiate the (remaining) discussion, and the rest of the members are encouraged to participate.
